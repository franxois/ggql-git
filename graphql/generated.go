...
func field_Query_project_args(rawArgs map[string]interface{}) (map[string]interface{}, error) {
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Project.currentBranch":
		if e.complexity.Project.CurrentBranch == nil {
			break
		}

		return e.complexity.Project.CurrentBranch(childComplexity), true

	case "Project.branches":
		if e.complexity.Project.Branches == nil {
			break
		}
	...
	case "Query.project":
		...
		args, err := field_Query_project_args(rawArgs)
		if err != nil {
			return 0, false
		}
...
// nolint: vetshadow
func (ec *executionContext) _Project_currentBranch(ctx context.Context, field graphql.CollectedField, obj *project.Project) graphql.Marshaler {
	rctx := &graphql.ResolverContext{
		Object: "Project",
		Args:   nil,
		Field:  field,
...
// nolint: vetshadow
func (ec *executionContext) _Project_branches(ctx context.Context, field graphql.CollectedField, obj *project.Project) graphql.Marshaler {
	rctx := &graphql.ResolverContext{
		Object: "Project",
		Args:   nil,
		Field:  field,
	...
	for i, field := range fields {
		...
		case "projects":
			...
			go func(i int, field graphql.CollectedField) {
				out.Values[i] = ec._Query_projects(ctx, field)
				if out.Values[i] == graphql.Null {
					invalid = true
				}
				wg.Done()
		...
		case "project":
			wg.Add(1)
			go func(i int, field graphql.CollectedField) {
				out.Values[i] = ec._Query_project(ctx, field)
				wg.Done()
			}(i, field)
		case "__type":
...
func (ec *executionContext) _Query_project(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	ctx = graphql.WithResolverContext(ctx, rctx)
	resTmp := ec.FieldMiddleware(ctx, nil, func(ctx context.Context) (interface{}, error) {
		return ec.resolvers.Query().Project(ctx, args["name"].(string))
	})
	if resTmp == nil {
		return graphql.Null
	}
	...
	return ec._Project(ctx, field.Selections, res)
}
